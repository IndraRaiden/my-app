              ...
              <div className="space-y-8">
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-emerald-500/30 transition-all duration-300 group">
                  ...
                  <a 
                    ...
                    className="text-gray-400 hover:text-emerald-400 transition-colors duration-200 cursor-pointer block"
                  >
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-emerald-500/30 transition-all duration-300 group">
                  ...
                  <p className="text-gray-400 mb-1">+52 624 239 2710</p>
                  <p className="text-gray-400 mb-4">+52 56 63 95 4818</p>
                  
                  {/* Action Buttons */}
                  <div className="flex gap-3 mt-6">
                    <a
                      href="sms:+526242392710"
                      className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 hover:border-emerald-500/50 rounded-lg text-emerald-400 hover:text-emerald-300 transition-all duration-200 group/btn"
                    >
