              ...
              <div className="relative mt-12 overflow-hidden rounded-2xl border border-emerald-500/30 bg-slate-950/92 shadow-2xl shadow-black/40 animate-fade-up">
                ...
                <div className="relative p-8 space-y-6">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex items-start gap-4 animate-fade-up-delay">
                      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-500/10 ring-1 ring-emerald-500/40 text-emerald-300/90">
                        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex items-start gap-4 animate-fade-up-delay-2">
                      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-500/10 ring-1 ring-emerald-500/40 text-emerald-300/90">
                        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="pt-5 border-t border-emerald-500/15 animate-fade-up-delay-3">
