...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "contact.companyLabel": "Nombre De la Empresa/Negocio",
    "contact.companyPlaceholder": "Tu Empresa S.A.",
    ...
    "portfolio.project1Title": "Sitio de Ultrasonidos",
    "portfolio.project1Desc": "Sitio web profesional para servicios de ultrasonido, desarrollado con Nuxt.js y diseño responsivo optimizado para consultas médicas.",
    "portfolio.project2Title": "Sitio de Bienes Raíces",
    "portfolio.project2Desc": "Landing page moderna para servicios inmobiliarios, desarrollada con Nuxt.js y diseño optimizado para conversión y captura de leads.",
    "portfolio.project3Title": "Plataforma Web de Productos",
    "portfolio.project3Desc": "Plataforma web desarrollada en Next.js con integración de Strapi CMS y catálogo dinámico de más de 300+ productos.",
    "portfolio.project4Title": "Portal Gobierno Piedras Negras",
    "portfolio.project4Desc": "Plataforma gubernamental desarrollada en Nuxt.js con Payload CMS y Supabase, incluye sección de noticias editable sin código y más de 300 archivos cargados.",
    "portfolio.project5Title": "Portal de Transparencia",
    "portfolio.project5Desc": "Sitio web de transparencia gubernamental para Piedras Negras, Coahuila, con sistema de carga de archivos e integración de base de datos.",
    "portfolio.project6Title": "Portal Educativo con IA",
    "portfolio.project6Desc": "Portal educativo integrado con inteligencia artificial, diseño moderno con modo oscuro/claro y experiencia de usuario optimizada.",
  ...
  en: {
    ...
    "contact.companyLabel": "Company/Business Name",
    "contact.companyPlaceholder": "Your Company Inc.",
    ...
    "portfolio.project1Title": "Ultrasound Website",
    "portfolio.project1Desc": "Professional website for ultrasound services, developed with Nuxt.js and responsive design optimized for medical consultations.",
    "portfolio.project2Title": "Real Estate Website",
    "portfolio.project2Desc": "Modern landing page for real estate services, developed with Nuxt.js and optimized design for conversion and lead capture.",
    "portfolio.project3Title": "Product Web Platform",
    "portfolio.project3Desc": "Web platform developed in Next.js with Strapi CMS integration and dynamic catalog featuring over 300+ products.",
    "portfolio.project4Title": "Piedras Negras Government Portal",
    "portfolio.project4Desc": "Government platform developed in Nuxt.js with Payload CMS and Supabase, features code-free editable news section and over 300 files uploaded.",
    "portfolio.project5Title": "Transparency Portal",
    "portfolio.project5Desc": "Government transparency website for Piedras Negras, Coahuila, with file upload system and database integration.",
    "portfolio.project6Title": "AI Education Portal",
    "portfolio.project6Desc": "AI-integrated education portal with modern dark/light mode design and optimized user experience.",
