...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "portfolio.project6Title": "Sitio Corporativo Ideal Adapt",
    "portfolio.project6Desc": "Sitio web corporativo profesional en WordPress con diseño a medida, integración de servicios y optimización SEO completa.",
  ...
  en: {
    ...
    "portfolio.project6Title": "Ideal Adapt Corporate Site",
    "portfolio.project6Desc": "Professional corporate website in WordPress with custom design, service integration, and complete SEO optimization.",
